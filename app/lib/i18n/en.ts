...
const en = {
  ...
  endorsementsPage: {
    ...
    people: [
      ...
      { name: 'Amanda Fritz', title: 'Former Portland City Commissioner', imageSrc: '/endorsements/amanda-fritz.jpg', quote: 'Multnomah County needs a new District 2 Commissioner with decades of experience working in multiple County departments, and proven success helping people with housing, mental health, and community justice issues. Nabil is the best candidate to serve in this important leadership position.' },
      { name: 'Kayse Jama', title: 'Oregon State Senator & Senate Majority Leader', imageSrc: '/endorsements/kayse-jama.png' },
      { name: 'Dan Ryan', title: 'Portland City Councilor, District 2', imageSrc: '/endorsements/dan-ryan.png', quote: 'I first got to know Nabil in 2024, when we were both candidates for Portland City Council. Nabil understands how government works, and how to bring community, public and private partners together to get things done! He is authentic, experienced, and a true public servant. Recently, Nabil and I walked through the King neighborhood in District 2 and talked with each other about the challenges and opportunities facing our community from homelessness, behavioral health and public safety to economic opportunity and coalition building. Nabil is NOT part of the status quo that has plagued the county for a decade plus, he is ready to shake things up! I\u2019m proud to endorse Nabil Zaghloul for Multnomah County Commissioner, District 2.' },
      { name: 'Sameer Kanal', title: 'Portland City Councilor, District 2', imageSrc: '/endorsements/sameer-kanal.png' },
      ...
      { name: 'Stan Penkin', title: 'Community Leader', imageSrc: '/endorsements/stan-penkin.png', quote: 'Nabil has the proven experience, knowledge and passion necessary to get our county on the right track. He understands the issues and will help bring much needed accountability and change.' },
      ...
      { name: 'Alex Green', title: 'Former Green Bay Packers Running Back', imageSrc: '/endorsements/alex-green.png', quote: 'As someone who believes in giving back to the community that helped shape my life, I respect leaders who lead with humility, accountability, and action. Nabil has consistently shown those qualities throughout his career.' },
      ...
      { name: 'Rossana Tejada', title: 'Former Community Health Nurse, Multnomah County Health Department', imageSrc: '/endorsements/rossana-tejada.JPG', quote: 'I have known Nabil for more than 20 years. We received unconditional support for our maternal and infant families facing housing eviction, transportation issues, domestic violence, addiction, and lack of food on people\u2019s tables. Nabil knows the challenges of our community.' },
      { name: 'Beth McKinney', title: 'Retired Nurse & ONA Member', imageSrc: '/endorsements/beth-mckinney.JPEG', quote: 'Having worked closely with Nabil in a medical setting, I have seen firsthand that he understands the larger social determinants of health. He listens; he acts.' },

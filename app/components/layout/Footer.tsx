...
export default function Footer() {
  return (
    <footer className="bg-surface border-t border-border" role="contentinfo">
      <div className="mx-auto max-w-[var(--content-max)] px-6 md:px-8 lg:px-12 py-8">
        {/* Links + Social */}
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="flex flex-col gap-1.5 text-xs text-text-subtle">
            <a
              href="/privacy"
              className="hover:text-text transition-colors duration-150 motion-reduce:transition-none focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded"
            >
              Privacy Policy
            </a>
            <a
            ...
            <div className="flex items-center gap-4">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  aria-label={`Visit us on ${social.label} (opens in new tab)`}
                  className="text-text-subtle hover:text-text transition-colors duration-150 motion-reduce:transition-none focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded"
                >
